        ...
        <Col>
          <Container fluid="md" className="d-flex justify-content-center">
            <Form className="profile-box">
              ...
              <Form.Label className="text-start my-3">Email: </Form.Label>
              <Form.Group className="mb-5 d-flex align-items-center">
                <Form.Control placeholder="Enter email" />
                <Button className="ms-4">Edit</Button>
              </Form.Group>
              <Form.Label className="text-start my-3">Nickname: </Form.Label>
              <Form.Group className="mb-5 d-flex align-items-center">
                <Form.Control placeholder="Enter nickname" />
                <Button className="ms-4">Edit</Button>
              </Form.Group>
              <Form.Label className="text-start my-3">Password: </Form.Label>
              <Form.Group className="mb-5 d-flex align-items-center">
